...
const Header = (prop) => {
    ...
    const { search, setSearch, priceLowtohigh, priceHightolow, fetchproduct } = prop;
...

                    {
                        ...
                        <div className= 'card-details' style={{width: '24rem', padding: 10}}>
                         ...
                         <div className='card-details'>
                            <i className='fas fa-close' onClick={handleClose}/>
                ...
                <div className="container-fluid">
                    <ul className="navbar-nav">
                        <li className="nav-item" >
                            <a className="nav-link" href="#" id="electronics" onClick={(e) => fetchproduct(e)}>Electronics</a>
                        </li>
                        <li className="nav-item" onClick={(e) => fetchproduct(e)}>
                            <a className="nav-link" href="#" id="jewelery">Jewellery</a>
                        </li>
                        <li className="nav-item" onClick={(e) => fetchproduct(e)}>
                            <a className="nav-link" href="#" id="clothing">Clothing</a>
                        </li>
                        {/* <li className="nav-item" >
